...
public class adminpage extends JFrame{
	...
	public adminpage() {
		...
		addservice.setBounds(319, 86, 148, 37);
		...
		AddStaff.setBounds(319, 154, 148, 37);
		...
		assignstaff.setBounds(319, 222, 148, 37);
		...
		back1.setBounds(319, 357, 148, 37);
		adminpage1.add(back1);
		
		JButton assignstafftxt = new JButton("ASSIGN STAFF");
		assignstafftxt.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		assignstafftxt.setBounds(319, 290, 148, 37);
		adminpage1.add(assignstafftxt);
	}
